...
public class Email {
    ...
    public void GetData() throws IOException {
        ...
        // Read SendGrid credentials from environment variables (injected by GitHub Actions)
        authUser = System.getenv("SENDGRID_AUTHUSER");
        password = System.getenv("SENDGRID_APIKEY");
